...
//generowanie przeszkody
  const obstacle = document.createElement('div');
    ...
    obstacle.style.left = `${Math.floor(Math.random() * 800) }px`;
    obstacle.style.top = '0px';
    gameArea2.appendChild(obstacle);

  const moveInterval_obstacle = setInterval(() => {
    obstacle.style.top = `${parseInt(obstacle.style.top) + 18}px`;
...
const Interval_obstacle = setInterval(createObstacle, 800);
const Interval_obstacle2 = setInterval(createObstacle, 1800);
const Interval_obstacle3 = setInterval(createObstacle, 1900);
const Interval_obstacle4 = setInterval(createObstacle, 2000);
...
function createcolorg() {
  ...
  //generowanie przeszkody
    const colorg = document.createElement('div');
      ...
      colorg.style.left = `${Math.floor(Math.random() * 849)}px`;
...
function createcolorp() {
  ...
  //generowanie przeszkody
    ...
    colorp.style.left = `${Math.floor(Math.random() * 849)}px`;
...
function createcolorr() {
  ...
  //generowanie przeszkody
    ...
    colorr.style.left = `${Math.floor(Math.random() * 849) }px`;
...
function createcolorb() {
  ...
  //generowanie przeszkody
    ...
    colorb.style.left = `${Math.floor(Math.random() * 849) }px`;
...
function createNitro(){
  ...
  nitro.style.left = `${Math.floor(Math.random() * 849)}px`;
  nitro.style.top = '0px';
...
function moveObstacles() {
  ...
  for (const obstacle of obstacles) { 
    if (checkCollision(obstacle)) {
     ...
     clearInterval(Interval_obstacle3)
     clearInterval(Interval_obstacle4)
 ...
 #game-background {
       ...
       height: 100%;
       z-index: -1;
       animation: move-background 0.7s linear infinite;
       background-image: url('road.svg');
       background-position: 0 0;
     }
