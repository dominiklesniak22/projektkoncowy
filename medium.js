...
#game-background {
      ...
      height: 100%;
      z-index: -1;
      animation: move-background 1.1s linear infinite;
...
//generowanie przeszkody
  ...
  const moveInterval_obstacle = setInterval(() => {
    obstacle.style.top = `${parseInt(obstacle.style.top) + 15}px`;
...
const Interval_obstacle3 = setInterval(createObstacle, 2300);
...
function moveObstacles() {
 ...
 #game-background {
       ...
       height: 100%;
       z-index: -1;
       animation: move-background 0.9s linear infinite;
       background-image: url('road.svg');
       background-position: 0 0;
     }
